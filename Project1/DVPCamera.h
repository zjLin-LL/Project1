...
/**
*@brief  User may get the red digital gain value by invoking this function.
*@param[in] handle  Specifies the camera handle.  
*@param[out] pRGain  The pointer to a floating-point variable that can be used for saving the red digital gain value. 
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetRGainState
*@see dvpGetRGainState
*@see dvpGetRGainDescr
*@see dvpSetRGain
*/
dvp2api dvpStatus dvpGetRGain(dvpHandle handle, float *pRGain);


/**
*@brief User may set the red digital gain value by invoking this function.   
*@param[in] handle  Specifies the camera handle.  
*@param[in] RGain  Specifies the red digital gain value to be set.
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetRGainState
*@see dvpGetRGainState
...
*@see dvpGetRGain
*/
dvp2api dvpStatus dvpSetRGain(dvpHandle handle, float RGain);
...
/**
*@brief User may get the enabled status of the red digital gain by invoking this function.  
*@param[in] handle  Specifies the camera handle. 
*@param[out] pRGainState  The pointer to a Boolean variable that can be used for saving the enabled status of the red digital gain. 
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetRGain
*@see dvpGetRGain
...
*@see dvpSetRGainState
*/
dvp2api dvpStatus dvpGetRGainState(dvpHandle handle, bool *pRGainState);


/**
*@brief User may set the enabled status of the red digital gain by invoking this function.  
*@param[in] handle  Specifies the camera handle.
*@param[in] RGainState  Specifies the enabled status of the red digital gain to be set. 
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetRGain
*@see dvpGetRGain
...
*@see dvpGetRGainState
*/
dvp2api dvpStatus dvpSetRGainState(dvpHandle handle, bool RGainState);


/**
*@brief User may get the green digital gain value by invoking this function. 
*@param[in] handle 	Specifies the camera handle.  
*@param[out] pGGain  The pointer to a floating-point variable that can be used for saving the green digital gain value. 
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetGGainState
*@see dvpGetGGainState
*@see dvpGetGGainDescr
*@see dvpSetGGain
*/
dvp2api dvpStatus dvpGetGGain(dvpHandle handle, float *pGGain);


/**
*@brief User may set the green digital gain value by invoking this function.
*@param[in] handle 	Specifies the camera handle.  
*@param[in] GGain  Specifies the green digital gain value to be set.
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetGGainState
*@see dvpGetGGainState
...
*@see dvpGetGGain
*/
dvp2api dvpStatus dvpSetGGain(dvpHandle handle, float GGain);
...
/**
*@brief User may get the enabled status of the green digital gain by invoking this function.
*@param[in] handle  Specifies the camera handle.
*@param[out] pGGainState  The pointer to a Boolean variable that can be used for saving the enabled status of the green digital gain.   
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetGGain
*@see dvpGetGGain
...
*@see dvpSetGGainState
*/
dvp2api dvpStatus dvpGetGGainState(dvpHandle handle, bool *pGGainState);


/**
*@brief User may set the enabled status of the green digital gain by invoking this function.
*@param[in] handle  Specifies the camera handle.  
*@param[in] GGainState  Specifies the enabled status of the green digital gain to be set.  
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetGGain
*@see dvpGetGGain
...
*@see dvpGetGGainState
*/
dvp2api dvpStatus dvpSetGGainState(dvpHandle handle, bool GGainState);


/**
*@brief User may get the blue digital gain value by invoking this function. 
*@param[in] handle  Specifies the camera handle. 
*@param[out] pBGain  The pointer to a floating-point variable that can be used for saving the blue digital gain value.
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetBGainState
*@see dvpGetBGainState
*@see dvpGetBGainDescr
*@see dvpSetBGain
*/
dvp2api dvpStatus dvpGetBGain(dvpHandle handle, float *pBGain);


/**
*@brief User may set the blue digital gain value by invoking this function. 
*@param[in] handle  Specifies the camera handle. 
*@param[in] BGain  Specifies the blue digital gain value to be set.
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetBGainState
*@see dvpGetBGainState
...
*@see dvpGetBGain
*/
dvp2api dvpStatus dvpSetBGain(dvpHandle handle, float BGain);
...
/**
*@brief User may get the enabled status of the blue digital gain by invoking this function. 
*@param[in] handle  Specifies the camera handle.
*@param[out] pBGainState  The pointer to a Boolean variable that can be used for saving the enabled status of the blue digital gain. 
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetBGain
*@see dvpGetBGain
...
*@see dvpSetBGainState
*/
dvp2api dvpStatus dvpGetBGainState(dvpHandle handle, bool *pBGainState);


/**
*@brief User may set the enabled status of the blue digital gain by invoking this function.  
*@param[in] handle  Specifies the camera handle.
*@param[in] BGainState  Specifies the enabled status of the blue digital gain to be set.
*@return Status code  DVP_STATUS_OK if the call succeeds.
*@ingroup __DVP_COLOR__
*@see dvpSetBGain
*@see dvpGetBGain
...
*@see dvpGetBGainState
*/
dvp2api dvpStatus dvpSetBGainState(dvpHandle handle, bool BGainState);
